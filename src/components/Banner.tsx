...
export default function Banner({ banners }: BannerProps) {
  ...
  return (
    <div className="relative min-h-[620px] overflow-hidden dark-tech-band">
      {/* 背景图片 */}
      <div
        className="absolute inset-0 bg-cover bg-center transition-all duration-1000 opacity-70"
        style={{ backgroundImage: `url(${banners[currentIndex].image})` }}
      >
        {/* 渐变遮罩 */}
        <div className="absolute inset-0 bg-[linear-gradient(105deg,rgba(5,8,16,0.88)_0%,rgba(6,17,31,0.76)_44%,rgba(6,17,31,0.38)_100%)]" />
      </div>
      ...
      <div className="relative z-10 mx-auto grid min-h-[620px] max-w-7xl items-center gap-10 px-4 py-20 lg:grid-cols-[1.05fr_0.95fr]">
        <div key={currentIndex} className="max-w-3xl animate-slideUp">
          ...
          <div className="flex flex-wrap items-center gap-4">
            <Link
              ...
              className="glow-btn inline-flex items-center gap-2 px-8 py-3.5"
            >
              查看产品体系
          ...
          <div className="tech-panel bg-white/10 p-6 text-white backdrop-blur-md">
            <div className="relative z-10">
              <div className="mb-6 flex items-center justify-between border-b border-white/10 pb-4">
                ...
                <span className="rounded-md border border-teal-300/30 px-3 py-1 text-xs font-semibold text-teal-100">ONLINE</span>
              </div>
