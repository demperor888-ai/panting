  ...
  return (
    <>
      ...
      <div className="fixed left-4 top-1/2 -translate-y-1/2 mt-20 z-50">
        <div className="bg-gradient-to-br from-blue-600/75 to-blue-700/75 backdrop-blur-sm rounded-xl shadow-xl p-3 w-36">
      ...
      <div className="fixed right-4 bottom-24 z-50 flex flex-col gap-3">
        ...
        {/* 微信二维码 */}
        <div className="w-12 h-12 bg-green-600 text-white rounded-full flex items-center justify-center shadow-lg hover:bg-green-700 transition group relative cursor-pointer" title="微信联系">
          ...
          <div className="absolute right-14 bottom-0 bg-white rounded-xl shadow-2xl p-3 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
            <img src="/images/banners/wx.png" alt="微信二维码" className="w-40 h-40" />
            <p className="text-gray-600 text-xs text-center mt-1">微信扫码联系</p>
          </div>
        </div>
