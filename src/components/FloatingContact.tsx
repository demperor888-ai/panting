...
export default function FloatingContact() {
  return (
    <div className="fixed right-4 bottom-24 z-50 flex flex-col gap-3">
      ...
      <a
        href="#"
        className="w-12 h-12 bg-green-600 text-white rounded-full flex items-center justify-center shadow-lg hover:bg-green-700 transition group relative"
        title="微信联系"
        onClick={(e) => {
          e.preventDefault();
          alert('微信: humanbeings_-');
        }}
      >
