  ...
  return (
    <div className="fixed right-4 bottom-24 z-50 flex flex-col gap-3">
      <a
        ...
        className="group relative flex h-12 w-12 items-center justify-center rounded-lg border border-white/20 bg-gradient-to-br from-teal-500 to-primary-800 text-white shadow-[0_14px_34px_rgba(6,17,31,0.22)] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_18px_44px_rgba(18,199,181,0.26)]"
        title="电话咨询"
      >
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
        </svg>
        <span className="absolute right-14 rounded-lg bg-dark-900 px-3 py-1.5 text-sm text-white opacity-0 shadow-lg transition group-hover:opacity-100 whitespace-nowrap">
          吴经理 电话咨询
        </span>
      </a>
      ...
      <Link
        href="/contact"
        className="group relative flex h-12 w-12 items-center justify-center rounded-lg border border-white/20 bg-gradient-tech text-white shadow-glow transition-all duration-300 hover:-translate-y-1 hover:shadow-glow-lg"
        title="联系我们"
      >
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
