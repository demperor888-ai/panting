          ...
          <div className="space-y-1">
            {productCategories.map((cat) => (
              <Link
                ...
                className="block px-3 py-2 text-sm text-gray-600 hover:bg-primary-50 hover:text-primary-600 rounded-lg transition"
              >
                {cat.name}
              </Link>
            ))}
            <Link
              href="/contact"
              className="block px-3 py-2 text-sm text-primary-600 font-medium hover:bg-primary-50 rounded-lg transition border-t mt-1 pt-2"
            >
              立即咨询 →
            </Link>
          </div>
