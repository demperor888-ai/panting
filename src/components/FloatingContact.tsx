  ...
  return (
    <div className="fixed right-4 bottom-24 z-50 flex flex-col gap-3">
      ...
      >
        ...
        <span className="absolute right-14 rounded-lg bg-surface-900 px-3 py-1.5 text-sm text-white opacity-0 shadow-lg transition group-hover:opacity-100 whitespace-nowrap">
          吴经理 电话咨询
        </span>
      </a>
