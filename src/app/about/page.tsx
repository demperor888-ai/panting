...
export default function AboutPage() {
  ...
  const honors = ['高新技术企业', 'ISO9001认证', '质量信得过单位', '诚信企业'];
        ...
        <ScrollReveal>
          <section className="tech-panel p-8 mb-8">
            <div className="relative z-10">
              ...
              <h2 className="text-2xl font-bold text-surface-800 mt-2 mb-6">公司简介</h2>
              <div className="grid md:grid-cols-[1.1fr_0.9fr] gap-8">
                ...
                <motion.div
                  className="h-72 rounded-xl overflow-hidden shadow-glow"
        ...
        <ScrollReveal delay={0.15}>
          <section className="tech-panel p-8 mb-8">
            <div className="relative z-10">
              ...
              <h2 className="text-2xl font-bold text-surface-800 mt-2 mb-6">主营产品</h2>
                ...
                {productCategories.map((cat, i) => (
                  ...
                  >
                    <Link
                      ...
                      className="group relative overflow-hidden rounded-xl border border-surface-200 bg-gradient-to-br from-surface-50 to-white p-4 text-center transition-all duration-300 hover:border-teal-300/60 hover:shadow-glow block"
                    >
                      <div className="w-full h-20 mb-3 rounded-lg overflow-hidden bg-surface-100">
                      ...
                      <p className="font-semibold text-surface-700 group-hover:text-brand-600 transition-colors text-sm">{cat.name}</p>
        ...
        <ScrollReveal delay={0.2}>
          <section className="tech-panel p-8">
            <div className="relative z-10">
              ...
              <h2 className="text-2xl font-bold text-surface-800 mt-2 mb-6">资质荣誉</h2>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                {honors.map((honor, index) => (
                  <motion.div
                    ...
                    className="relative overflow-hidden rounded-xl border border-surface-200 bg-gradient-to-br from-surface-50 to-white p-6 text-center transition-all duration-300 hover:border-teal-300/60 hover:shadow-glow group"
                  >
                    ...
                    <p className="font-semibold text-surface-700">{honor}</p>
                  </motion.div>
                ))}
              </div>
            </div>
